...
<body>
<img id="delicia" src="imagens/ODONTOfundo.png">
<section>
  <div class="container" >
    ...
    <div class="content">     
      ...
      <section id="login">
          ...
          <img id= "imagemICONE" align="center" width="350" height="150" src="imagens/OTlogo.png" />
          ...
          <p class="link1">
           Ainda não tem conta? 
            <a id="Cadastrese" href="Cadastro.jsp">Cadastre-se</a>
          </p>

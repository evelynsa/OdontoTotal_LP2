...
<jsp:useBean id="use" class="model.UsuarioDao"/>
            ...
            <div class="mainpanel">
                <jsp:include page="./pageheader.jsp">
                    ...
                    <jsp:param name="pageLocation"
                               value="Manutenção / Listar Cidade" />
                    <jsp:param name="pageName" value="Listar Usuario" />
                </jsp:include>
                <div class="contentpanel">
                    <div class="table-responsive">
                        ...
                        <table class="table mb30 table-hover">
                            ...
                            <tbody>
                                <c:forEach var="usuario" items="${use.imprimir}">
                                    <tr>
                                    ...
                                    <th>${usuario.login}</th>
                                    <th>${usuario.senha_usuario}</th>
                                    <th>${usuario.email_usuario}</th>
                                    <th>${usuario.sexo_usuario}</th>
